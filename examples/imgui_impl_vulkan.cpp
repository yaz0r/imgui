...
//  2018-09-11: Vulkan: Added QueuedFramesCount field in ImGui_ImplVulkan_InitInfo, required for initialization (was previously a hard #define IMGUI_VK_QUEUED_FRAMES 2).
//  2018-09-11: Vulkan: Added ImGui_ImplVulkan_SetQueuedFramesCount() to override QueuedFramesCount while running.
...
static int                          g_QueuedFramesCount = 0;
...
bool    ImGui_ImplVulkan_Init(ImGui_ImplVulkan_InitInfo* info, VkRenderPass render_pass)
{
    ...
    g_QueuedFramesCount = info->QueuedFramesCount;
...
static void ImGui_ImplVulkan_SwapBuffers(ImGuiViewport* viewport, void*)
{
    ...
    check_vk_result(err);
    wd->FrameIndex = (wd->FrameIndex + 1) % g_QueuedFramesCount;
}
